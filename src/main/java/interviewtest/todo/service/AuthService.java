...
import interviewtest.todo.model.request.LoginUserRequest;
import interviewtest.todo.model.response.TokenResponse;
...
public class AuthService {
    ...
    private Long next30Days() {
        return System.currentTimeMillis() + (1000 * 60 * 1 * 1 * 1);
    }
